...
if __name__ == '__main__':
    ...
    pipeline = Pipeline()
    pipeline.add_task(component_name_to_class_dict['TradeDayProducer'])
    pipeline.add_task(component_name_to_class_dict['TradeDayProcessor'])
    pipeline.add_task(component_name_to_class_dict['TradeDayStorager'])
